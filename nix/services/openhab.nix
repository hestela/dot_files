...
let
  ...
  #dockerImage = "openhab-tz-fix";
  dockerImage = "openhab/openhab:3.2.0";
in
{
  ...
  systemd.services.openhab = {
    ...
    serviceConfig = {
      ...
      ExecStart = "${pkgs.docker}/bin/docker run --name openhab --net=host -v /etc/localtime:/etc/localtime:ro   -v /home/openhab/conf:/openhab/conf -v /home/openhab/userdata:/openhab/userdata -v /home/openhab/addons:/openhab/addons -e USER_ID=1002 -e GROUP_ID=498 -e OPENHAB_HTTP_PORT=7080 -e OPENHAB_HTTPS_PORT=7443 --restart=always -v /dev/ipmi0:/dev/ipmi0 ${dockerImage}";
